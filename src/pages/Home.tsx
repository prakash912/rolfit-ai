...
import { ArrowRight, FileText, Check, Zap, ChevronRight, BarChart, Star } from "lucide-react";
...
const Home = () => {
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
            ...
            <div className={`lg:col-span-5 transition-all duration-1000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
              <div className="inline-flex items-center px-3 py-1 rounded-full bg-blue-50 text-blue-600 text-sm font-medium mb-6">
                <Zap size={14} className="mr-1.5" /> AI-Powered Hiring Optimization
              </div>
              ...
              <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold tracking-tight text-slate-900 mb-4 sm:mb-6 leading-tight">
                RoleFit AI: <span className="relative inline-block">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
              ...
              <div className="reveal fade-bottom delay-500">
                <div className="bg-slate-50 rounded-2xl p-8 h-full transition-all duration-300 hover:shadow-md hover:-translate-y-1">
                  ...
                  <h3 className="text-xl font-bold text-slate-900 mb-3">AI Hiring Analysis</h3>
                  <p className="text-slate-600">
                     The AI compares resumes against job descriptions, JD checklists, and ATS requirements, highlighting the best-fit candidates instantly.
                  </p>
                </div>
              </div>
              ...
              <div className="reveal fade-bottom delay-700">
                <div className="bg-slate-50 rounded-2xl p-8 h-full transition-all duration-300 hover:shadow-md hover:-translate-y-1">
                  ...
                  <h3 className="text-xl font-bold text-slate-900 mb-3">Download Hiring Report</h3>
                  <p className="text-slate-600">
                   HR receives candidate report cards with overall fit, strengths, weaknesses, and recommendations - all downloadable in PDF for quick decision-making.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
              ...
              <div className="bg-white/70 backdrop-blur-sm border border-slate-100 rounded-xl p-6 reveal fade-bottom delay-300 hover:shadow-md transition-all duration-300 hover:-translate-y-1">
                ...
                <p className="text-slate-700 mb-6">
                   "With over 4,000 resumes to process, our HR team was drowning in manual screening. This AI tool helped us shortlist candidates 70% faster while improving overall fit quality."
                </p>
                ...
                <div className="flex items-center">
                  ...
                  <div>
                    <p className="font-medium text-slate-900">Anita Sharma</p>
                    <p className="text-sm text-blue-600">HR Head, Aster Healthcare</p>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-white/70 backdrop-blur-sm border border-slate-100 rounded-xl p-6 reveal fade-bottom delay-500 hover:shadow-md transition-all duration-300 hover:-translate-y-1">
                ...
                <p className="text-slate-700 mb-6">
                  "Earlier, shortlisting a role took us days. Now with AI-driven JD checklists and scoring, we finalize top candidates within hours. It has transformed our hiring process."
                </p>
                ...
                <div className="flex items-center">
                  ...
                  <div>
                    <p className="font-medium text-slate-900">Rahul Verma</p>
                    <p className="text-sm text-blue-600">Talent Acquisition, Swiggy</p>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-white/70 backdrop-blur-sm border border-slate-100 rounded-xl p-6 reveal fade-bottom delay-700 hover:shadow-md transition-all duration-300 hover:-translate-y-1">
                ...
                <div className="flex items-center">
                  ...
                  <div>
                    <p className="font-medium text-slate-900">Meera Iyer</p>
                    <p className="text-sm text-blue-600">HR Manager, Khatabook</p>
                  </div>
                </div>
              </div>
            </div>
  ...
  "Before adopting RoleFit AI, strong profiles were getting buried in our ATS queue. With JD-weighted scoring and evidence-backed reports, we now shortlist 4k+ resumes to the top 1% in hours - not days - and our hiring managers finally have clarity."
</p>
                  ...
                  <div className="flex items-center">
                    ...
                    <div>
                      ...
                      <p className="text-blue-600">Hiring Manager at Microsoft</p>
                    </div>
                  </div>
                </div>
              </div>
      ...
      <section className="py-16 sm:py-20 md:py-24 bg-blue-600 text-white">
        ...
        not days - ensuring faster shortlisting, better candidate fit, and smarter hiring decisions.
            ...
            >
              <span className="mr-2">Start Hiring Smarter</span>
              <ArrowRight size={16} className="sm:size-[18px]" />
          </Button>
          </div>
        </div>
