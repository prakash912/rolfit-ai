        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-6 sm:gap-8 md:gap-12 text-center sm:text-left">
          ...
          <div className="col-span-1 sm:col-span-2">
            <div className="mb-4 sm:mb-6">
              <span className="font-bold text-xl sm:text-2xl text-slate-900">RoleFit AI</span>
            </div>
            <p className="text-sm sm:text-base text-slate-600 mb-4 sm:mb-6 max-w-sm mx-auto sm:mx-0">
  Using AI to help HR teams quickly identify the best candidates from thousands of resumes.
</p>

            <div className="flex justify-center sm:justify-start space-x-4">
              <a 
                href="https://x.com/PrakashRan61522" 
                target="_blank" 
              ...
              <a 
                href="https://www.linkedin.com/in/prakash-ranjan-rai/" 
                target="_blank" 
                rel="noopener noreferrer"
                className="w-8 h-8 rounded-full bg-slate-100 flex items-center justify-center text-slate-600 hover:bg-blue-100 hover:text-blue-600 transition-colors"
                aria-label="LinkedIn"
              ...
              <a 
                href="https://github.com/prakash912" 
                target="_blank" 
                rel="noopener noreferrer"
                className="w-8 h-8 rounded-full bg-slate-100 flex items-center justify-center text-slate-600 hover:bg-blue-100 hover:text-blue-600 transition-colors"
                aria-label="GitHub"
          ...
          <div>
            ...
            <ul className="space-y-3 sm:space-y-4">
              ...
              <li>
                <Link to="/" className="text-sm sm:text-base text-slate-600 hover:text-blue-600 transition-colors inline-flex items-center group">
                  <span>Aceplus</span>
                  <ArrowUpRight size={12} className="sm:size-[14px] ml-1 transition-transform group-hover:translate-x-1" />
                </Link>
              </li>
          ...
          <div>
            ...
            <ul className="space-y-3 sm:space-y-4">
              <li>
                <Link to="https://www.symbtechnologies.com/about-us/" className="text-sm sm:text-base text-slate-600 hover:text-blue-600 transition-colors inline-flex items-center group">
                  <span>About Us</span>
                  <ArrowUpRight size={12} className="sm:size-[14px] ml-1 transition-transform group-hover:translate-x-1" />
                </Link>
              </li>
              <li>
                <Link to="https://www.symbtechnologies.com/contact/" className="text-sm sm:text-base text-slate-600 hover:text-blue-600 transition-colors inline-flex items-center group">
                  <span>Contact</span>
                  <ArrowUpRight size={12} className="sm:size-[14px] ml-1 transition-transform group-hover:translate-x-1" />
                </Link>
              </li>
              <li>
                <a href="mailto:support@aicareerforge.com" className="text-sm sm:text-base text-slate-600 hover:text-blue-600 transition-colors inline-flex items-center group">
                  <span>info@symbtechnologies.com</span>
                  <ArrowUpRight size={12} className="sm:size-[14px] ml-1 transition-transform group-hover:translate-x-1" />
                </a>
              </li>
            </ul>
        ...
        <div className="border-t border-slate-100 mt-10 sm:mt-16 pt-6 sm:pt-8 flex flex-col md:flex-row justify-between items-center text-slate-500 text-xs sm:text-sm">
          <p>&copy; {currentYear} RoleFit AI. All rights reserved.</p>
          <div className="flex space-x-4 sm:space-x-6 mt-4 md:mt-0">
            <Link to="https://www.symbtechnologies.com/privacy-policy/" className="hover:text-blue-600 transition-colors">
              Privacy Policy
            </Link>
            <Link to="https://www.symbtechnologies.com/terms-and-conditions/" className="hover:text-blue-600 transition-colors">
              Terms of Service
            </Link>
          </div>
        </div>
